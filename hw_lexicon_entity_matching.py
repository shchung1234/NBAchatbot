...
#turn 0
df.add_system_transition(State.START, State.TURN0, '"Hi, I am NBA chatbot. I can talk to you about NBA news. Do you have a favorite player in the league?"')
...
df.add_system_transition(State.TURN1S2, State.TURN0, '"That person is not currently in the NBA. Is there any current players you like? If you dont have any, we can talk about teams too!"')
